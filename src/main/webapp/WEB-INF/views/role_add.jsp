...
<jsp:include page="header.jsp" />
                ...
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <form role="form" action="<c:url value="/home/general/configuration/role/add/"/>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Name Role</label>
                                <input name="name" class="form-control" placeholder="Name Role">
                            </div>
