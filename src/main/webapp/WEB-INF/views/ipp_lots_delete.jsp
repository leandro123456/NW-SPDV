                	...
                	<div class="col-lg-12"></br>
                		<div class="panel panel-default">
	                        ...
	                        <div class="panel-body">
	                        	<form role="form" action="<c:url value="/home/ipp/delete/lots/" />${id}" method="post" enctype="multipart/form-data"> 
