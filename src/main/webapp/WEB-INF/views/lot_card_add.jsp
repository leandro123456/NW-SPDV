                ...
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Create Lot Of Card</h3>
                        </div>
                        <div class="panel-body">
                        <form role="form" action="<c:url value="/home/general/configuration/lot/card/add/"/>" method="post" enctype="multipart/form-data">
