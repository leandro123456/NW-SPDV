                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            eReach - ${nameAction} Lot ${lote} to Users
                        </h1>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12"></br>
                        <div class="panel-body">
                            ...
                            <form role="form" action="<c:url value="/home/general/configuration/lot/users/${action}/" />${lote}" method="post" enctype="multipart/form-data">
