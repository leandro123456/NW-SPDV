                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            eReach - Template to delete Lots
                        </h1>
                    </div>
                </div>
                	...
                	<div class="col-lg-12"></br>
                		<div class="panel panel-default">
	                        <div class="panel-heading">
	                            <h3 class="panel-title">Template ${id}</h3>
	                        </div>

	                        <div class="panel-body">
	                        	<form role="form" action="<c:url value="/home/template/lots/delete/" />${id}" method="post" enctype="multipart/form-data"> 
